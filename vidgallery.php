...
<title>Video Gallery | EduNotesHub</title>
...
$result_count = mysqli_query($con,"SELECT  COUNT(*) As total_records from movies ORDER BY mid DESC");
...
$result = mysqli_query($con,"SELECT  *from movies ORDER BY mid DESC LIMIT $offset, $total_records_per_page");
?>
<?php
                
                while($row = mysqli_fetch_array($result)) { ?>
<div class="w-5/12 sm:w-3/12 md:w-2/12 mx-1 md:mx-3 my-2 inline-flex flex-col">
<a  class="cursor-pointer overflow-hidden group block shadow-sm" href="vvideo.php?viewid=<?php echo $row['mid'];?>">
<div class="relative overflow-hidden">
<img class="w-full group-hover:scale-110 transform transition-transform img-fixed" alt="" src="videos/uploads/<?php echo $row['imgpath']; ?>"download>
...
</span><span class="absolute top-3 z-10 font-semibold right-0 bg-blue-400 px-3 drop-shadow py-0 text-white opacity-90 text-sm">mp4
</span>
</div>
