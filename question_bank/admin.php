<?php
 ...
 if (isset($_POST['upload'])) {
     ...
     $sql = "INSERT INTO questionbnk (name, sem, decription, imgpath, videopath) VALUES ('$name', '$sem', '$desc', '$image', '$video')";
...
<head>
    <meta charset="utf-8">
    <title>QB Upload | EduNotesHub</title>
...
<body>
    <div class="card">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input type="text" class="form-control" placeholder="Semester" name="release" required>
            </div>
            <div class="form-group">
