...
$result_count = mysqli_query($con,"SELECT  COUNT(*) As total_records from ebooks ORDER BY mid ASC");
...
$result = mysqli_query($con,"SELECT  *from ebooks ORDER BY mid ASC LIMIT $offset, $total_records_per_page");
?>
<?php
...
<img class="w-full group-hover:scale-110 transform transition-transform img-fixed" alt="" src="ebooks/uploads/<?php echo $row['imgpath']; ?>"download>
...
<b><?php echo $row['name']; ?></b><br><br><a href="ebooks/video-uploads/<?php echo $row['videopath']; ?>"><center><button class="button2" type="button">
